...
int maxActivities(int n,vector<int> &start,vector<int> &end) {
    vector<pair> v;
    for(int i = 0 ; i < n ; i++) {
...
void output(int &n,vector<int> &start,vector<int> &end) {
    cout<<"Printing The Start Time Of Each Activity : "<<endl;
    for(int i = 0 ; i < n ; i++) {
        cout<<start[i] << ' ';
    }
    cout<<endl;
    cout<<"Printing The End Time Of Each Activity : "<<endl;
    for(int i = 0 ; i < n ; i++) {
        cout<<end[i] << ' ';
    }
    cout<<endl;
...
int main()
{
    ...
    input(n,start,end);
    output(n,start,end);
    cout<<"A Person Can Perform Maximum Activities : "<<maxActivities(n,start,end)<<endl;
}